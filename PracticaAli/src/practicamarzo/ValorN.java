...
public class ValorN {
	...
	// si un número % número2 == 0 significa que el número es DIVISIBLE entre
	// número2
	// por lo que no hay resto (por eso vale 0)

	// el módulo de un número entre 2 sólo puede ser 0 o 1
	// o dicho de otra forma, si el resto de un número entre 2 es 0, ese número es
	// PAR
	// si el resto de un número entre 2 es 1, ese número es IMPAR (sobra 1 número,
	// por eso vale 1)
