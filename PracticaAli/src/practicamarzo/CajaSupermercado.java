...
public class CajaSupermercado {
	 ...
	 * PARA ESTE EJERCICIO, VAMOS A USAR UN NÚMERO DOUBLE
	 * YA QUE UN PRECIO PUEDE SER DE 23,33; 23,00, ... PUEDE TENER COMAS
	 */
	...
	public static double calcularTotal(double precioSinIVA, double IVA) {
		// devolvemos el precio sin IVA + el IVA en euros calculado con el método calcularIVA
